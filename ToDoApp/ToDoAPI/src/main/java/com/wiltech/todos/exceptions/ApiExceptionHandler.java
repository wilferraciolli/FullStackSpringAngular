package com.wiltech.todos.exceptions;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private PropertyField buildPropertyFieldError(ObjectError error) {
        ...
        return new PropertyField(((FieldError) error).getField(), ((FieldError) error).getRejectedValue(),
                messageSource.getMessage(error, LocaleContextHolder
                        .getLocale()));
    }
}
