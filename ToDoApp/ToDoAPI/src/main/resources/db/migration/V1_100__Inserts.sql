...
insert into todo(id, name, description, created_date_time, state_id, enabled)
values (3000, 'Sample To do', ' Description of sample to do', '2020-01-01 12:00:00', 'NEW', 1);

insert into todo(id, name, description, created_date_time, state_id, enabled)
values (3001, 'Sample To do 2', ' Description of sample to do 2', '2020-01-31 19:00:00', 'STARTED', 1);
