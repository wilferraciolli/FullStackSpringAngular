...
public class DataIngestionService {
    ...
    private void insertDocuments() {
        // This method assumes there is a document on the resources path to read, otherwise change it for some other data
        ...
        // get the document, split onto text segments and add as embeddings tot he Vector DB
    ...
    private EmbeddingModel getEmbeddingModel() {
        String openaiApiKey = ChatConstants.OPENAI_API_KEY;
